...
def main():
    ...
    # Define blurring augmentation
    blur_transform = transforms.Compose([
        transforms.GaussianBlur(kernel_size=3)
    ])
    print("Initializing image data manager")
    # dm = ImageDataManager(use_gpu, **dataset_kwargs(args))
    # Modify the dataset loader to include the blurring augmentation
    dm = ImageDataManager(use_gpu, transform=blur_transform, **dataset_kwargs(args))
