...
def main():
    ...
    # Define horizontal flipping augmentation
    flip_transform = transforms.RandomHorizontalFlip()

    print("Initializing image data manager")
    # dm = ImageDataManager(use_gpu, **dataset_kwargs(args))
    # Modify the dataset loader to include the combined augmentation
    dm = ImageDataManager(use_gpu, transform=flip_transform, **dataset_kwargs(args))
